...
![styleAR result](./img/input_output.png){: width="800"}
...
- 입력물:
    ...
    |목차|내용|비고|
    |:-:|:-:|:-:|
    |얼굴영상|![styleAR result](./img/face.jpg){: width="200"}|얼굴이 사진의 40%이상 차지|
    |귀걸이 사진|![styleAR result](./img/input_1.png){: width="300"}|영상편집 시 귀걸이 위와 아래의 공백을 최대한 작게 <br />영상은 귀걸이를 제외한 배경은 투명처리(png 포멧)|
